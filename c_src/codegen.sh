...
$CC $ERL_CFLAGS -P -D BITNESS=12 -E c_src/ecirca.c > c_src/ecirca_small.c \
&&
$CC $ERL_CFLAGS -P -D BITNESS=28 -E c_src/ecirca.c > c_src/ecirca_medium.c \
&&
$CC $ERL_CFLAGS -P -D BITNESS=60 -E c_src/ecirca.c > c_src/ecirca_large.c
